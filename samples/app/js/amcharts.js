...
AmCharts.ValueAxis = AmCharts.Class({
    inherits: AmCharts.AxisBase, construct: function (a) {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)c = !0; else {
            ...
            this.exponential = !1;
            for (f = p; f < q; f += n)t = AmCharts.roundTo(this.step * f + this.min, s), -1 != String(t).indexOf("e") && (this.exponential = !0, String(t).split("e"));
            ...
            for (f = p; f < q; f += n)if (p = s * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)if (isNaN(w) || Number(AmCharts.toFixed(p, w)) == p) {
                ...
                if (!isNaN(I) && 0 < t && f < q - 1) {
                    v = this.gridAlpha;
                    this.gridAlpha = this.minorGridAlpha;
                    for (e = 1; e < s / I; e++)u = this.getCoordinate(p + I * e), u = new this.axisItemRenderer(this, u, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(u);
                    this.gridAlpha = v
                }
            }
            r = this.baseValue;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l, m) {
        ...
        this.set = s;
        var w = a.axisThickness, v = a.axisColor, t = a.axisAlpha, u = a.tickLength, x = a.gridAlpha, F = a.gridThickness, B = a.gridColor, z = a.dashLength, I = a.fillColor, E = a.fillAlpha, H = a.labelsEnabled;
        m = a.labelRotation;
        var V = a.counter, T = a.inside, fa = a.labelOffset, aa = a.dx, ga = a.dy, Na = a.orientation, ma = a.position, ba = a.previousCoord, Q = a.viH, X = a.viW, na = a.offset, $, W;
        ...
        if ("H" == Na) {
            if (0 <= b && b <= X + 1 && (0 < u && 0 < t && b + k <= X + 1 && ($ = AmCharts.line(r, [b + k, b + k], [0, u], v, t, F), s.push($)), 0 < x && (W = AmCharts.line(r, [b, b + aa, b + aa], [Q, Q + ga, ga], B, x, F, z), s.push(W))), A = 0, G = b, g && 90 == m && T &&
                ...
                2 * Math.cos(Y)) : 0 > m ? (A = Q + u + 3 - S / 2 * Math.sin(Y) + 2, G += S / 2 * Math.cos(Y)) : A += u + w + 3 + 3, A += fa)) : (A += ga + p / 2 - na, G += aa, T ? (0 < m ? (A = S / 2 * Math.sin(Y) + u + 3, G -= S / 2 * Math.cos(Y)) : A += u + 3, A += fa) : (0 < m ? (A = -(S / 2) * Math.sin(Y) - u - 6, G += S / 2 * Math.cos(Y)) : A -= u + p + 3 + w + 3, A -= fa)), "bottom" == ma ? ja = (T ? Q - u - 1 : Q + w - 1) + na : (ka = aa, ja = (T ? ga : ga - u - w + 1) - na), f && (G += f), f = G, 0 < m && (f += S / 2 * Math.cos(Y)), Z && (p = 0, T && (p = S / 2 * Math.cos(Y)), f + p > X + 2 || 0 > f))Z.remove(), Z = null
        } else {
            0 <= b && b <= Q + 1 && (0 < u && 0 < t && b + k <= Q + 1 && ($ = AmCharts.line(r, [0, u], [b + k, b + k], v, t, F), s.push($)),
            0 < x && (W = AmCharts.line(r, [0, aa, X + aa], [b, b + ga, b + ga], B, x, F, z), s.push(W)));
            W = "end";
            if (!0 === T && "left" == ma || !1 === T && "right" == ma)W = "start";
            A = b - p / 2;
            1 == V && 0 < E && !g && !l && (d = AmCharts.fitToBounds(b, 0, Q), ba = AmCharts.fitToBounds(ba, 0, Q), Y = d - ba, fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, Y, Y], I, E), fill.translate(aa, d - Y + ga), s.push(fill));
            A += p / 2;
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
        ...
        isNaN(h) && (h = .8);
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate, r = this.columnCount, s = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), w = this.connect, v = [], t = [], u, x, F, B, z = this.chart.graphs.length, I, E = this.dx / this.tcc, H = this.dy / this.tcc, V = f.stackType,
            T = this.start, fa = this.end, aa = this.scrollbar, ga = this.categoryAxis, Na = this.baseCoord, ma = this.negativeBase, ba = this.columnIndex, Q = this.lineThickness, X = this.lineAlpha, na = this.lineColorR, $ = this.dashLength, W = this.set, Y, ja = this.getGradRotation(), G = this.chart.columnSpacing, A = ga.cellWidth, ka = (A * h - r) / r;
        G > ka && (G = ka);
        var S, y, Z, eb = n + 1, fb = m + 1, Wa = 0, gb = 0, hb, ib, Xa, Ya, jb = this.fillColorsR, Da = this.negativeFillColors, wa = this.negativeLineColor, Oa = this.fillAlphas, Pa = this.negativeFillAlphas;
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < T) {
                for (J = T - 1; -1 < J; J--)if (S = d[J],
                        y = S.axes[f.id].graphs[b], Z = y.values.value, !isNaN(Z)) {
                    T = J;
                    break
                }
            ...
            if (fa < d.length -
                1)for (J = fa + 1; J < d.length; J++)if (S = d[J], y = S.axes[f.id].graphs[b], Z = y.values.value, !isNaN(Z)) {
                fa = J;
                break
            }
        }
        ...
        var Db = this.noStepRisers, $a = -1E3, ab = -1E3, bb = this.minDistance, Fa = !0, Qa = !1;
        for (J = T; J <= fa; J++) {
            S = d[J];
            y = S.axes[f.id].graphs[b];
            y.index = J;
            var Ra, Ga = NaN;
            if (l && void 0 == this.openField)for (var kb = J + 1; kb < d.length && (!d[kb] || !(Ra = d[J + 1].axes[f.id].graphs[b]) || !Ra.values || (Ga = Ra.values.value, isNaN(Ga))); kb++);
            var R, P, L, ca, ha = NaN, D = NaN, C = NaN, M = NaN, K = NaN, Ha = NaN, xa = NaN, Ia = NaN, ya = NaN, sa = NaN, ta = NaN, da = NaN, ea = NaN, U = NaN, lb = NaN, mb = NaN, ia = NaN, qa = void 0, Ca = jb, Ka = Oa, ua = na, oa, ra, nb = this.proCandlesticks, Sa = this.pattern;
            ...
            if (va) {
                U = this.stackable && "none" !=
                V && "3d" != V ? va.close : va.value;
                ...
                var ha = S.x[ga.id], La = this.periodSpan -
                    1, la = Math.floor(A / 2) + Math.floor(La * A / 2), za = la, cb = 0;
                ...
                -1E5 > ha && (ha = -1E5);
                ha > m + 1E5 && (ha = m + 1E5);
                q ? (D = C, M = K, K = C = ha, isNaN(ia) && !this.fillToGraph &&
                (M = Na), Ha = xa, Ia = ya) : (M = D = ha, isNaN(ia) && !this.fillToGraph && (K = Na));
                ...
                switch (g) {
                    case "line":
                        if (isNaN(U))w || (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = []); else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb)v.push(D), t.push(C), $a = D, ab = C;
                            sa = D;
                            ta = C;
                            da = D;
                            ea = C;
                            !Ea || isNaN(K) || isNaN(M) || (N.push(M), O.push(K));
                            if (Qa || void 0 != y.lineColor || void 0 !=
                            ...
                            y.gap && (this.drawLineGraph(v, t, N, O), v = [], t = [], N = [], O = [])
                        }
                        break;
                    case "smoothedLine":
                        if (isNaN(U))w || (this.drawSmoothedGraph(v, t, N, O), v = [], t = [], N =
                            [], O = []); else {
                            if (Math.abs(D - $a) >= bb || Math.abs(C - ab) >= bb)v.push(D), t.push(C), $a = D, ab = C;
                            sa = D;
                            ta = C;
                            ...
                            ea = C;
                            !Ea || isNaN(K) || isNaN(M) || (N.push(M), O.push(K));
                            void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawSmoothedGraph(v, t, N, O), v = [D], t = [C], N = [], O = [], !Ea || isNaN(K) || isNaN(M) || (N.push(M), O.push(K)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength);
                            y.gap && (this.drawSmoothedGraph(v, t, N, O), v = [], t = [], N = [], O = [])
                        }
                        break;
                    case "step":
                        if (!isNaN(U)) {
                    ...
                    case "column":
                        ...
                        var Eb = this.topRadius;
                        if (!isNaN(U)) {
                            l || (y.isNegative = U < ma ? !0 : !1);
                            y.isNegative && (Da && (Ca = Da), void 0 != wa && (oa = wa));
                            var Fb = f.min, Gb = f.max;
                            if (!(U < Fb && ia < Fb || U > Gb && ia > Gb)) {
                                var pa;
                                if (q) {
                                    "3d" == V ? (P = C - (r / 2 - this.depthCount + 1) * (h + G) + G / 2 + H * ba, R = M + E * ba, pa = ba) : (P = Math.floor(C - (r / 2 - ba) * (h + G) + G / 2), R = M, pa = 0);
                                    L = h;
                                    sa = D;
                                    ta = P + h / 2;
                                    ...
                                    P < n && 0 < L && (qa = new AmCharts.Cuboid(e, ca, L, E - a.d3x, H - a.d3y, Ca, Ka, Q, oa, X, ja, s, q, $, Sa, Eb), y.columnWidth = Math.abs(ca), y.columnHeight = Math.abs(L))
                                } else {
                                    "3d" == V ? (R = D - (r / 2 - this.depthCount + 1) * (h + G) + G / 2 + E * ba, P = K + H * ba, pa = ba) : (R = D - (r / 2 - ba) * (h + G) + G / 2, P = K, pa = 0);
                                    L = h;
                                    sa = R + h / 2;
                                    ta = C;
                                    ...
                                    ca = C - K;
                                    var Rb = P;
                                    P = AmCharts.fitToBounds(P, this.dy, n);
                                    ca += Rb - P;
                                    ca = AmCharts.fitToBounds(ca,
                                        -P + H * ba, n - P);
                                    R < m + ba * E && 0 < L && (this.showOnAxis && (P -= H / 2), qa = new AmCharts.Cuboid(e, L, ca, E - a.d3x, H - a.d3y, Ca, Ka, Q, oa, this.lineAlpha, ja, s, q, $, Sa, Eb), y.columnHeight = Math.abs(ca), y.columnWidth = Math.abs(L))
                                }
                            }
                            if (qa && (ra = qa.set, y.columnGraphics = ra, ra.translate(R, P), this.columnsSet.push(ra), (y.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !aa)) {
                                "none" == V && (I = q ? (this.end + 1 - J) * z - c : z * J + c);
                                "3d" == V && (q ? (I = (this.end + 1 - J) * z - c - 1E3 * this.depthCount, sa += E * this.columnIndex, da += E * this.columnIndex, y.y += E * this.columnIndex) :
                                    (I = (z - c) * (J + 1) + 1E3 * this.depthCount, ta += H * this.columnIndex, ea += H * this.columnIndex, y.y += H * this.columnIndex));
                    ...
                    case "candlestick":
                        if (!isNaN(ia) && !isNaN(U)) {
                            ...
                            void 0 != y.lineColor && (oa = y.lineColor);
                            if (q) {
                                if (P = C - h / 2, R = M, L = h, P + L > n && (L = n - P),
                                    0 > P && (L += P, P = 0), P < n && 0 < L) {
                                    var qb, rb;
                                    U > ia ? (qb = [D, Ia], rb = [M, Ha]) : (qb = [M, Ia], rb = [D, Ha]);
                                    !isNaN(Ia) && !isNaN(Ha) && C < n && 0 < C && (db = AmCharts.line(e, qb, [C, C], oa, X, Q), pb = AmCharts.line(e, rb, [C, C], oa, X, Q));
                                    ca = D - M;
                                    qa = new AmCharts.Cuboid(e, ca, L, E, H, Ca, Oa, Q, oa, X, ja, s, q, $, Sa)
                                }
                            } else if (R = D - h / 2, P = K + Q / 2, L = h, R + L > m && (L = m - R), 0 > R && (L += R, R = 0), ca = C - K, R < m && 0 < L) {
                                nb && U >= ia && (Ka = 0);
                                var qa = new AmCharts.Cuboid(e, L, ca, E, H, Ca, Ka, Q, oa, X, ja, s, q, $, Sa), sb, tb;
                                U > ia ? (sb = [C, ya], tb = [K, xa]) : (sb = [K, ya], tb = [C, xa]);
                                !isNaN(ya) && !isNaN(xa) && D < m &&
                                0 < D && (db = AmCharts.line(e, [D, D], sb, oa, X, Q), pb = AmCharts.line(e, [D, D], tb, oa, X, Q))
                            }
                            qa && (ra = qa.set, y.columnGraphics = ra, W.push(ra), ra.translate(R, P - Q / 2), (y.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), db && (W.push(db), W.push(pb)), sa = D, ta = C, q ? (ea = C, da = D, "open" == k && (da = M), "high" == k && (da = Ia), "low" == k && (da = Ha)) : (ea = C, "open" == k && (ea = K), "high" == k && (ea = ya), "low" == k && (ea = xa), da = D), aa || (y.x = q ? P + L / 2 : R + L / 2, this.animateColumns(qa, J, D, M, C, K), this.addListeners(ra, y)))
                        }
                        break;
                    case "ohlc":
                        if (!(isNaN(ia) || isNaN(lb) ||
                            ...
                            var ub, vb, wb;
                            if (q) {
                                var xb = C - h / 2, xb = AmCharts.fitToBounds(xb, 0, n), Hb = AmCharts.fitToBounds(C, 0, n), yb = C + h / 2, yb = AmCharts.fitToBounds(yb, 0, n);
                                vb = AmCharts.line(e, [M, M], [xb, Hb], ua, X, Q, $);
                                0 < C && C < n && (ub = AmCharts.line(e, [Ha, Ia], [C, C], ua, X, Q, $));
                                wb = AmCharts.line(e, [D, D], [Hb, yb], ua, X, Q, $);
                                ea = C;
                                da = D;
                                "open" == k && (da = M);
                                "high" == k && (da = Ia);
                                ...
                                var zb = D - h / 2, zb = AmCharts.fitToBounds(zb, 0, m), Ib = AmCharts.fitToBounds(D, 0, m), Ab = D + h / 2, Ab =
                                    AmCharts.fitToBounds(Ab, 0, m);
                                vb = AmCharts.line(e, [zb, Ib], [K, K], ua, X, Q, $);
                                0 < D && D < m && (ub = AmCharts.line(e, [D, D], [xa, ya], ua, X, Q, $));
                                wb = AmCharts.line(e, [Ib, Ab], [C, C], ua, X, Q, $);
                                ea = C;
                                "open" == k && (ea = K);
                                "high" == k && (ea = ya);
                                "low" == k && (ea = xa);
                ...
                if (!aa && !isNaN(U)) {
                    var Jb = this.hideBulletsCount;
                    if (this.end - this.start <= Jb || 0 === Jb) {
                        var Sb = this.createBullet(y, da, ea, J), Kb = this.labelText;
                        if (Kb) {
                            var Bb = this.createLabel(y, da, ea, Kb);
                            (Bb = this.positionLabel(sa, ta, Bb, Sb, L, ca)) &&
                            this.allBullets.push(Bb)
                        }
                        if ("regular" == V || "100%" == V) {
                            var Lb = f.totalText;
                            if (Lb) {
                                var Ma = this.createLabel(y, 0, 0, Lb, f.totalTextColor);
                                this.allBullets.push(Ma);
                                var Mb = Ma.getBBox(), Nb = Mb.width, Ob = Mb.height, Ta, Ua, Pb = f.totals[J];
                                Pb && Pb.remove();
                                var Va = 0;
                                "column" != g && (Va = bulletSize);
                                q ? (Ua = C, Ta = 0 > U ? D - Nb / 2 - 2 - Va : D + Nb / 2 + 3 + Va) : (Ta = D, Ua = 0 > U ? C + Ob / 2 + Va : C - Ob / 2 - 3 - Va);
                                Ma.translate(Ta, Ua);
                                f.totals[J] = Ma;
        ...
        g ? this.drawSmoothedGraph(v, t, N, O) : this.drawLineGraph(v, t, N, O), aa || this.launchAnimation();
        ...
        var e = this;
        if (1 < a.length) {
            var f = e.set, g = e.chart, h = e.container,
                k = h.set(), l = h.set();
            f.push(l);
            f.push(k);
            ...
            if (0 < f || 0 < t)if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0])) : (n.push(n[n.length - 1]), q.push(u),
            ...
            v || (v = s), h = AmCharts.polygon(h, n, q, v, t, 1, "#000", 0, a), h.pattern(e.pattern), l.push(h), l.click(function (a) {
        ...
        if (1 < a.length) {
            var e = this.set, f = this.container, g = f.set(),
                h = f.set();
            e.push(h);
            e.push(g);
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n = this.lineColorR, p = this.fillColorsR, q = this.negativeLineColor, r = this.negativeFillColors, s = this.negativeFillAlphas, w = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
        ...
        if (!isNaN(b) && !isNaN(c)) {
            ...
            h = f;
            this.bulletAxis &&
            (f = a.values.error, isNaN(f) || (g = f), f = this.bulletAxis.stepWidth * g);
            ...
            if (this.customBullet || a.customBullet)p = this.customBullet, a.customBullet && (p = a.customBullet), p && (n && n.remove(), "function" == typeof p ? (n = new p, n.chart = this.chart, a.bulletConfig && (n.availableSpace = c, n.graph = this,
                n.graphDataItem = a, n.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, n.bulletConfig = a.bulletConfig), n.write(d), n = n.set) : (this.chart.path && (p = this.chart.path + p), n = d.set(), d = d.image(p, 0, 0, f, f), n.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
            n && ((a.url || this.showHandOnHover) && n.setAttr("cursor", "pointer"), "serial" == this.chart.type && (0 > b - 0 || b - 0 > this.width || c < -f / 2 || c - 0 > this.height) && (n.remove(), n = null), n && (this.bulletSet.push(n), n.translate(b, c), this.addListeners(n, a), this.allBullets.push(n)),
                a.bx = b, a.by = c);
        ...
        if (a) {
            ...
            d = this.showBalloon;
            c.chartCursor && "serial" == c.type && (d = !1, !c.chartCursor.valueBalloonsEnabled &&
            this.showBalloon && (d = !0));
            if (d) {
        ...
        if (a) {
            var c = {
                type: "rollOutGraphItem", item: a, index: a.index, graph: this, target: this,
                chart: this.chart, event: b
            };
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function (a) {
        ...
        if (this.enabled) {
            ...
            this.fireMoved();
            if (q) {
                var r = q.x[g.id], s = c.rotate, w = this.stepWidth, v = this.categoryBalloon, t = this.firstTime, u = this.lastTime, x = this.cursorPosition, F = this.zooming, B = this.panning, z = c.graphs;
                if (c.mouseIsOver || F || B || this.forceShow)if (this.forceShow = !1, B) {
                    var h = this.panClickPos, c = this.panClickEndTime, F = this.panClickStartTime,
                        I = this.panClickEnd, l = this.panClickStart, e = (s ? h - f : h - e) / w;
                    if (!g.parseDates || g.equalSpacing)e = Math.round(e);
                    0 !== e && (h = {
                        type: "zoomed",
                        target: this
                    }, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > u && (e = u - c), F + e < t && (e = t - F), h.start = Math.round(F + e), h.end = Math.round(c + e), this.fire(h.type, h)) : I + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = I + e, this.fire(h.type, h)))
                } else {
                    ...
                    if (0 < this.cursorAlpha) {
                        ...
                        0 < w && !this.zooming ? isNaN(this.previousX) ? E.translate(t, u) : (E.translate(this.previousX, this.previousY), E.animate({translate: t + "," + u}, w, "easeOutSine")) : E.translate(t, u);
                        this.previousX = t;
                        this.previousY =
                            u;
                        E.show()
                    ...
                    F && (d && E.hide(), s ? this.updateSelectionSize(NaN, r) : this.updateSelectionSize(r, NaN));
                    w = !0;
                    F && (w = !1);
                    ...
                    if (this.oneBalloonOnly) {
                        r = Infinity;
                        for (g = 0; g < z.length; g++)t = z[g], t.showBalloon && !t.hidden && t.balloonText && (u = q.axes[t.valueAxis.id].graphs[t.id], v = u.y, isNaN(v) || (s ? Math.abs(e - v) < r && (r = Math.abs(e - v), I = t) : Math.abs(f - v) < r && (r = Math.abs(f - v), I = t)));
                    ...
                    if (a != this.previousIndex || I != this.previousMostCloseGraph)if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], z && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                        this.valueBalloons =
                            w = [];
                        for (g = 0; g < z.length; g++)if (t = z[g], v = NaN, (!this.oneBalloonOnly || t == I) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (q = this.data[a + 1]), q)) {
                    ...
                    b ? (h = {type: "changed"}, h.index = a, h.chart = this.chart, h.zooming = F, h.mostCloseGraph = I, h.position = s ? f : e, h.target = this, c.fire("changed", h), this.fire("changed",
    ...
    construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                B < g && (B = g);
                B + z > k && (B = k - z);
                var h = x + s, l = B + r, s = this.shadowAlpha, E = this.shadowColor, r = this.borderThickness, H = this.bulletSize, V;
                0 < t || 0 === w ? (0 < s && (a = AmCharts.rect(e, z, u, n, 0, r + 1, E, s, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), n = AmCharts.rect(e, z, u, n, this.fillAlpha, r, p, this.borderAlpha,
                    this.cornerRadius), this.showBullet && (V = AmCharts.circle(e, H, q, this.fillAlpha), f.push(V))) : (q = [], t = [], "H" != v ? (g = a - B, g > z - w && (g = z - w), g < w && (g = w), q = [0, g - w, a - B, g + w, z, z, 0, 0], t = I ? [0, 0, b - x, 0, 0, u, u, 0] : [u, u, b - x, u, u, 0, 0, u]) : (q = b - x, q > u - w && (q = u - w), q < w && (q = w), t = [0, q - w, b - x, q + w, u, u, 0, 0], q = a < g + (k - g) / 2 ? [0, 0, B < a ? 0 : a - B, 0, 0, z, z, 0] : [z, z, B + z > a ? z : a - B, z, z, 0, 0, z]), 0 < s && (a = AmCharts.polygon(e, q, t, n, 0, r, E, s), a.translate(1, 1), f.push(a)), n = AmCharts.polygon(e, q, t, n, this.fillAlpha, r, p, this.borderAlpha));
                this.bg = n;
                f.push(n);
                n.toFront();
                e = 1 * this.deltaSignX;
                ...
                for (F = 0; F < x.length; F++) {
                    ...
                    for (z = 0; z < a.length; z++) {
                        ...
                        if (b.valueAxis.id == B) {
                            ...
                            !b.connect && v && v[I] && t.time - p[I] > 1.1 * q && (v[I].gap = !0);
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < s && (s = 359.94);
    e >= s && (e = s);
    var w = 1 / 180 * Math.PI, s = b + Math.sin(d * w) * h, v = c - Math.cos(d * w) * q, t = b + Math.sin(d * w) * f, u = c - Math.cos(d * w) * g, x = b + Math.sin((d + e) * w) * f, F = c - Math.cos((d + e) * w) * g, B = b + Math.sin((d + e) * w) * h, w = c - Math.cos((d + e) * w) * q, z = {
    ...
    d = a.set();
    var E;
    r && (s = p(10 * s), t = p(10 * t), x = p(10 * x), B = p(10 * B), v = p(10 * v), u = p(10 * u), F = p(10 * F), w = p(10 * w), b = p(10 * b), k = p(10 * k), c = p(10 * c), f *= 10, g *= 10, h *= 10, q *= 10, 1 > Math.abs(e) && 1 >= Math.abs(x - t) && 1 >= Math.abs(F - u) && (E = !0));
    e = "";
    var H;
    n && (z["fill-opacity"] = 0, z["stroke-opacity"] = l["stroke-opacity"] / 2, z.stroke = l.stroke);
    0 < k && (H = " M" + s + "," + (v + k) + " L" + t + "," + (u + k), r ? (E || (H += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (u + k) + "," + x + "," + (F + k)), H += " L" + B + "," + (w + k), 0 < h && (E || (H += " B" + (b - h) + "," + (k + c - q) + "," + (b + h) + "," + (k + c + q) +
    "," + B + "," + (k + w) + "," + s + "," + (k + v)))) : (H += " A" + f + "," + g + ",0," + I + ",1," + x + "," + (F + k) + " L" + B + "," + (w + k), 0 < h && (H += " A" + h + "," + q + ",0," + I + ",0," + s + "," + (v + k))), H = a.path(H + " Z", void 0, void 0, "1000,1000").attr(z), d.push(H), H = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + t + "," + (u + k) + " L" + t + "," + u + " L" + s + "," + v + " Z", void 0, void 0, "1000,1000").attr(z), k = a.path(" M" + x + "," + F + " L" + x + "," + (F + k) + " L" + B + "," + (w + k) + " L" + B + "," + w + " L" + x + "," + F + " Z", void 0, void 0, "1000,1000").attr(z), d.push(H), d.push(k));
    r ? (E || (e = " A" + p(b - f) + "," + p(c - g) +
    "," + p(b + f) + "," + p(c + g) + "," + p(t) + "," + p(u) + "," + p(x) + "," + p(F)), f = " M" + p(s) + "," + p(v) + " L" + p(t) + "," + p(u) + e + " L" + p(B) + "," + p(w)) : f = " M" + s + "," + v + " L" + t + "," + u + (" A" + f + "," + g + ",0," + I + ",1," + x + "," + F) + " L" + B + "," + w;
    0 < h && (r ? E || (f += " B" + (b - h) + "," + (c - q) + "," + (b + h) + "," + (c + q) + "," + B + "," + w + "," + s + "," + v) : f += " A" + h + "," + q + ",0," + I + ",0," + s + "," + v);
...
AmCharts.SVGRenderer = AmCharts.Class({
    ...
    move: function (a, b, c, d) {
        ...
        g = "#";
        AmCharts.baseHref && !AmCharts.isIE &&
        (g = this.removeTarget(window.location.href) + g);
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function (a) {
        ...
        for (u = 0; u < v.length; u++) {
            ...
            t = I.getBBox();
            var E;
            this.equalWidths ? E = f + x * (p + m + this.markerLabelGap) : (E = F, F = F + t.width + f + m);
            t.height > z && (z = t.height);
            E + t.width > n && 0 < u && 0 !== x && (q++, x = 0, E = f, F = E + t.width + f + m, B = B + z + l, z = 0);
            I.translate(E, B);
            x++;
            !isNaN(k) && x >=
            k && (x = 0, q++, B = B + z + l, z = 0);
        ...
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (n.translate(l + 1, l / 2), g.push(n)), p = 0, m = l, n = l / 3; else {
                var q;
