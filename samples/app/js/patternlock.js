var patternlock = {
    ...
    buttontouchend: function (b) {
        if (patternlock.isdrawing) {
            ...
            if (this.autoSubmit) {
                var dosubmit = true;
                // a string like "145" order-related
                var data=this.inputbox.value;
                $.ajax('',{
                    data:data,
...
function checkPattern() {
    ...
    if (pttrn == unlockPattrn && pttrn != "") {
        ...
        document.getElementById("content").innerHTML = "<img src='images/unlock/select.png'/><br><br><h3>Reload the Page to Set a different Pattern</h3>";
    }
    else {
