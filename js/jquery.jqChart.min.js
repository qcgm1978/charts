...
(function (a) {
    a.fn.jqChart = function (b, d, f) {
        if (typeof b === "object")d = b; else if (typeof b === "string") {
            b = b.toLowerCase();
            if (a.fn.jqChart.methods[b])return a.fn.jqChart.methods[b].call(this, d, f); else a.error("Method " + method + " does not exist on jQuery.jqChart")
        }
    ...
    a.fn.jqChart.defaults = {
        ...
        selectionRect: {fillStyle: "rgba(125,125,125,0.2)", strokeStyle: "gray", lineWidth: 0},
        shadows: {enabled: false, shadowColor: "#cccccc", shadowBlur: 8, shadowOffsetX: 2, shadowOffsetY: 2},
        watermark: {hAlign: "right", vAlign: "bottom"},
        noDataMessage: {text: "No data available", font: "20px sans-serif"},
        exportConfig: {server: "http://www.jqchart.com/export/default.aspx", method: "post"}
    };
    ...
    a.jqChartSprintf = function () {
        ...
        function d(a, d, b, c, g) {
            var f = c - a.length;
            if (f > 0)if (b || !g)a = e(a, c, " ", b); else a = a.slice(0, d.length) + e("", f, "0", true) + a.slice(d.length);
            return a
        }
        ...
        return h.replace(a.jqChartSprintf.regex, function (t, s, q, a, w, h, m) {
            ...
            if (!a)a = 0; else if (a == "*")a = +b[f++]; else if (a.charAt(0) == "*")a = +b[a.slice(1, -1)]; else a = +a;
            if (a < 0) {
                a = -a;
                j = true
            }
            if (!isFinite(a))throw new Error("sprintf: (minimum-)width must be finite");
            if (!h)h = "fFeE".indexOf(m) > -1 ? 6 : m == "d" ? 0 : void 0; else if (h == "*")h = +b[f++]; else if (h.charAt(0) == "*")h = +b[h.slice(1, -1)]; else h = +h;
    ...
    a.jqChartDateFormat = {
        masks: {shortDate: "m/d/yyyy", shortTime: "h:MM TT", longTime: "h:MM:ss TT"},
    ...
    d.prototype = {
        _createElements: function (c) {
            ...
            for (var f = ["touches", "changedTouches"], b = [], c = 0; c < f.length; c++)for (var e = h.originalEvent[f[c]], d = 0; d < e.length; d++) {
                var g = e[d];
            ...
            if (this._oldShape != null && this._oldShape == a)this._triggerShapeEvent("MouseMove", this._oldShape); else {
                if (this._oldShape != null) {
            ...
            if (!b)return;
            var a = this.hitTest(b.locX, b.locY);
            if (this._oldShape != null && this._oldShape == a)this._triggerShapeEvent("TouchMove", this._oldShape); else {
            ...
            if (e.result)f = e.result; else f = this._getTooltipText(b);
            this.tooltip.html(f);
            ...
            if (e.result !== false)if (d.use_excanvas)this.hlRenderer._render(b); else {
            ...
            for (var e = [], f = this.shapes.length - 1; f >= 0; f--) {
                ...
                if (d === true)e.push(a); else d && e.push(d)
            }
            ...
            if (c.fileName)b.fileName = c.fileName; else switch (b.type) {
                case"image/jpeg":
            ...
            if (!a)this.currentTool = this.defaultTool; else this.currentTool = a;
    ...
    jb.prototype = {
        ...
        _getMarkInterval: function (b, c) {
            var a;
            if (b.interval)a = b.interval; else if (c)a = this.actualInterval; else a = this.actualInterval / 2;
            return a
        },
            ...
            if (q) {
                for (var e = [], d = 0; d < n.length; d++) {
                    ...
                    for (var c = 0, c = 0; c < e.length; c++) {
                        var b = e[c];
                        if (o)f = k > b.y + b.h; else f = b.y > k + a.height;
                        if (f) {
                            b.y = k;
                            b.h = a.height;
                    ...
                    if (f == false)e[c] = {y: k, h: a.height, w: a.width + g, labels: [a]}
                }
                ...
                for (var e = [], d = 0; d < n.length; d++) {
                    ...
                    for (var f = false, c = 0, c = 0; c < e.length; c++) {
                        var b = e[c];
                        if (o)f = b.x > j + a.width + g; else f = j > b.x + b.w + g;
                        if (f) {
                            b.x = j;
                            b.w = a.width;
                    ...
                    if (f == false)e[c] = {x: j, w: a.width, h: a.height + g, labels: [a]}
                }
        ...
        _removeOverlappedLabels: function (c) {
            ...
            if (r)for (var v = [], b = 0; b < c.length; b++) {
                var d = b;
        ...
        _measure: function () {
            ...
            var a = {w: 0, h: 0};
            if (this.labels)if (this.labels.angle)a = this._measureRotatedLabels(this._getLabels()); else switch (this.labels.resolveOverlappingMode) {
                case"hide":
            ...
            if (this.isAxisVertical)a.w += c; else a.h += c;
        ...
        _getLabels: function () {
            ...
            for (var p = this._getLabelIntervals(q, c), r = p.length, t = c.showFirstLabel, u = c.showLastLabel, h = 0; h < r; h++) {
                ...
                switch (this.location) {
                    case"left":
                        if (g)a.x = this.x + this.width + e + i; else {
                    ...
                    case"top":
                        a.x = m;
                        if (g)a.y = this.y + this.height + e + a.height / 2 + j; else a.y = this.y + this.height - e - a.height / 2 - l + j;
                    ...
                    case"bottom":
                        a.x = m;
                        if (g)a.y = this.y - e - a.height / 2 + j; else a.y = this.y + e + a.height / 2 + l + j;
                        a.textBaseline = "middle";
                        switch (c.hAlign) {
                            case"center":
                                a.textAlign = "center";
        ...
        _getTickMarks: function (c, p) {
            ...
            for (var n = [], g = this.crossOffsetX, h = this.crossOffsetY, k = this.offset, j = c.position == "inside", r = this._getMarkInterval(c, p), b = c.length, o = this._getIntervals(r, c, p), d, f, e, a, m = 0; m < o.length; m++) {
                ...
                switch (this.location) {
                    case"left":
                        f = a = l;
                        if (j)e = this.x + this.width + b + this.lineWidth / 2 + g; else e = this.x + this.width - k + g;
                        d = e - b;
                        break;
                    case"right":
                        f = a = l;
                        if (j)d = this.x - b - this.lineWidth / 2 + g; else d = this.x + k + g;
                        e = d + b;
                        break;
                    case"top":
                        d = e = l;
                        if (j)a = this.y + this.height + b + this.lineWidth / 2 + h; else a = this.y + this.height - k + h;
                        f = a - b;
                        break;
                    case"bottom":
                        d = e = l;
                        if (j)a = this.y - b - this.lineWidth / 2 + h; else a = this.y + k + h;
                        f = a + b
                }
                var q = new i(d, f, e, a);
        ...
        getPosition: function (f) {
            ...
            if (c && b === false || c === false && b)a = this.origin + this.length - a; else a += this.origin;
            return a
        },
        getValue: function (f) {
    ...
    c.prototype.renderDashedLine = function (f, h, g, i, l, c) {
        ...
        while (!(d.thereYet(a, g) && e.thereYet(b, i))) {
            ...
            if (j)c.lineTo(a, b); else c.moveTo(a, b);
            k = (k + 1) % s;
            j = !j
        }
    ...
    c.prototype._createGradient = function (j, e) {
        ...
        var g = b.colorStops;
        if (g != null)for (var h = 0; h < g.length; h++) {
            var i = g[h];
    ...
    k.prototype.render = function (a, l) {
        ...
        if (e <= 0 || d <= 0)return;
        if (this.cornerRadius == 0)k.renderRectPath(a, f, g, e, d); else this.renderRoundedRectPath(a, f, g, e, d);
    ...
    z.prototype.getCenter = function (g) {
        ...
        var e = this.context;
        if (!e || !e.points)return {x: this.x + this.width / 2, y: this.y + this.height / 2};
    ...
    function bb(b, c, e, f) {
        ...
        if (b && b.length >= 2) {
            var d = [];
            a.merge(d, b);
            if (e)a.merge(d, [c, b[b.length - 1], c, b[1]]); else a.merge(d, [b[b.length - 2], c, b[0], c]);
    ...
    bb.prototype.render = function (d, g) {
        ...
        if (f <= 2)return;
        var e;
        if (this.isCurve)e = new u(a); else {
            e = new q(a);
    ...
    X.prototype.render = function (d, h) {
        ...
        if (g < 2)return;
        var f;
        if (this.isCurve)f = new u(e); else f = new q(e);
        d.beginPath();
        d.moveTo(e[0], e[1]);
        f.renderPoints(d, e, true);
        d.lineTo(a[0], a[1]);
        if (this.isCurve)f = new u(a); else f = new q(a);
    ...
    Kb.prototype.mouseWheel = function (d, c) {
        ...
        for (var b = 0; b < a.length; b++)if (this.view.options.mouseWheelInteractionMode == "scrolling")a[b]._mouseWheelScroll(c); else a[b]._mouseWheelZoom(c);
    ...
    W.prototype.start = function () {
        ...
        if (this.view.canZoomHor && this.view.canZoomVer)this.view.elem.css("cursor", "crosshair"); else if (this.view.canZoomHor)this.view.elem.css("cursor", "e-resize"); else this.view.elem.css("cursor", "s-resize")
    };
    ...
    P.prototype.touchMove = function (b) {
        ...
        if (a)this.doScale(b); else this.doPan(b)
    };
    P.prototype.touchEnd = function () {
        if (this.view.touchInput.length == 0)this.stopTool(); else this.oldTouchInput = null
    };
    ...
    e.prototype._setOptions = function (h) {
        ...
        if (typeof c.noDataMessage == "string")c.noDataMessage = {text: c.noDataMessage};
        ...
        var g = h || {};
        if (g.width)this.elem.css("width", g.width); else this.elem.width() == 0 && this.elem.css("width", "400px");
        if (g.height)this.elem.css("height", g.height); else this.elem.height() == 0 && this.elem.css("height", "250px");
    ...
    e.prototype._getShapesAtX = function (o, h, k, n) {
        for (var e = [h], j = [h.context.series], g = [0], i = 0; i < k.length; i++) {
            ...
            if (c != -1) {
                var m = g[c];
                if (f < m) {
                    if (d.mark)e[c] = d.mark; else e[c] = b;
                    g[c] = f
                }
                continue
            }
            if (d.mark)e.push(d.mark); else e.push(b);
            j.push(l);
            g.push(f)
        }
        return e
    ...
    e.prototype._initZooming = function () {
        ...
        a.each(this.axes.items, function () {
            if (this.zoomEnabled)if (this.location != "radial")if (this.isAxisVertical)b.canZoomVer = true; else b.canZoomHor = true
        });
        this.canZoom = this.canZoomVer || this.canZoomHor
    };
    e.prototype._triggerShapeEvent = function (b, a) {
        if (a.isLegendItem)this.legend._handleEvent(b, a); else a.context.series && a.context.series._handleEvent(b, a);
    ...
    e.prototype._renderShapes = function () {
        ...
        if (this.hasData) {
            var i = b.gaShapes;
            if (d.use_excanvas)this.areaRenderer._render(i); else {
                this.ctx.save();
            ...
            var c;
            if (d.use_excanvas)c = this.upperRenderer; else c = this.shapeRenderer;
    ...
    hb.prototype.render = function (d) {
        ...
        for (var b = 0; b < this.items.length; b++) {
            var a = this.items[b];
            this.setProperties(a);
            if (a instanceof k)if (this.isUp)a.fillStyle = this.priceUpFillStyle; else a.fillStyle = this.priceDownFillStyle;
            a.render(d)
        }
    };
    ...
    kb.prototype._init = function () {
        ...
        if (this.customItems)for (var d = 0; d < this.customItems.length; d++) {
    ...
    kb.prototype._arrange = function () {
        ...
        for (var i = this._isHorizontal(), f = this.rows, d = 0; d < this.items.length; d++) {
            ...
            } else e += a.width + this._itemMargin; else b += a.height;
            a._arrange()
        }
    };
    ...
    sb.prototype._measure = function () {
        var a;
        if (this.text)a = this.textBlock.measure(this.chart.ctx); else a = {width: 0, height: 0};
    ...
    B.prototype._getStripes = function (b) {
        ...
        a.each(d, function () {
            ...
            if (a.interval)j = a.interval; else j = 2 * b.actualInterval;
            var i;
            if (a.width)i = a.width; else i = b.actualInterval;
            for (var h = a.lineWidth, o = h / 2, n = b._getIntervals(j, a, true), m = 0; m < n.length; m++) {
                ...
                if (b.isAxisVertical)g = new k(c.x + o, Math.min(d, f), c.width - h, Math.abs(f - d)); else g = new k(Math.min(d, f), c.y + o, Math.abs(f - d), c.height - h);
                a._setSettings(g);
                e.push(g)
            }
        });
    ...
    f.prototype = {
        ...
        _addMarkerAndLabel: function (i, p, l, m, a, k, g, e, o, c) {
            if (!b.isNull(g) && !this.realXAxis.isValueVisible(g))return;
        ...
        _setShapeSettings: function (c, e) {
            if (this.fillStyles && !b.isNull(e))c.fillStyle = this.fillStyles[e % this.fillStyles.length]; else c.fillStyle = this.fillStyle;
        ...
        _processData: function () {
            this.arrData = null;
            if (this.data)if (!this.xValuesType && !this.yValuesType)this.arrData = b.cloneArray(this.data); else {
                this.arrData = [];
        ...
        _processErrorBars: function () {
            ...
            if (a && this.hasErrorBars && this.arrData)this.errorBarsObj = new ub(this, a)
        },
        _processNullValues: function () {
            ...
            for (var h = this.nullIndexes = [], e, d, f, g, a = 0; a < c.length; a++) {
                ...
                if (this.isSingleArrData) {
                    ...
                    h.push(a);
                    if (d)c[a] = [];
                    if (f)c[a][0] = b.calcNullValue(c, a, "x", this.xAxisType);
                    if (g)c[a][1] = b.calcNullValue(c, a, "y")
                }
            }
        },
        _processDataXYZ: function () {
            this.arrData = null;
            if (this.data)if (!this.xValuesType && !this.fromValuesType && !this.toValuesType)this.arrData = b.cloneArray(this.data); else {
                this.arrData = [];
                for (var d = 0; d < this.data.length; d++) {
                    var a = this.data[d].slice(0);
                    a[0] = b.processDataValue(a[0], this.xValuesType);
        ...
        _initCatValueData: function () {
            for (var k = this.arrData, h = j, g = m, f = [], l = k.length, e = 0; e < l; e++) {
                ...
                var c = d;
                if (a.isArray(d) == false)f.push((e + 1).toString()); else {
                    f.push(d[0]);
                    c = d[1]
                }
                if (!b.isNull(c)) {
        ...
        _calcStackedData: function (r, t, s) {
            for (var n = j, l = m, k = j, i = m, g = [], u = r.length, p = {}, f = 0; f < u; f++) {
                ...
                if (this.xAxisType == "CategoryAxis")if (a.isArray(c) == false)g.push((f + 1).toString()); else g.push(c[0]); else {
                    var d = c[0];
                ...
                if (c > 0) {
                    ...
                    b.negative += c;
                    b.value = b.negative
                } else if (e != null)b.value = e.value; else b.value = 0;
                p[q] = b;
                l = Math.max(l, b.value);
                n = Math.min(n, b.value)
            }
            var h = {min: n, max: l, dataValues: p};
            if (this.xAxisType == "CategoryAxis")h.categories = g; else {
                h.minX = k;
                h.maxX = i
            }
            return h
        ...
        _calcVisibleStackedData: function (s, w, u) {
            ...
            for (var o = j, n = m, x = s.length, q = {}, g = 0; g < x; g++) {
                ...
                if (this.xAxisType == "CategoryAxis") {
                    if (l && g + 1 < i || k && g > h)continue
                } else {
                    var t = d[0];
                    if (l && t < i || k && t > h)continue
                }
                ...
                if (d > 0) {
                    ...
                    c.negative += d;
                    c.value = c.negative
                } else if (f != null)c.value = f.value; else c.value = 0;
                q[r] = c;
        ...
        _findAxis: function (b, d) {
            if (d != null)for (var a = 0; a < b.length; a++) {
                var c = b[a];
        ...
        _getLegendItems: function (d) {
            ...
            var g;
            if (this.title != null)g = this.title; else {
        ...
        _getPixelMargins: function (d) {
            ...
            if (f)b = e.height / 2 + c.height + g; else b = e.width / 2 + c.width + g;
            if (k && !f || !k && f) {
                b += h;
                b *= 1.25;
                var m = b / d.length;
            ...
            if (d.getOrientation(this) == "x")b = Math.max(b, 6); else b = Math.max(b, 12);
            var i = this.errorBarsObj;
        ...
        _getStackedTotal: function (e, f) {
            for (var d = 0, c = 0, b = 0; b < e.length; b++) {
                ...
                if (!a)continue;
                if (a.actualValue > 0)d += a.actualValue; else c += a.actualValue
            }
        ...
        _getXValue: function (c, d) {
            ...
            if (this.xAxisType == "CategoryAxis")if (a.isArray(c) == false)b = (d + 1).toString(); else b = c[0]; else {
                b = c[0];
                if (a.type(b) == "date")b = b.getTime()
            }
            if (b)b = b.toString(); else b = "";
            return b
        },
        ...
        _calcColumnScale: function (l) {
            for (var f = [], b = 0; b < l.length; b++)a.merge(f, l[b].arrData || []);
            f.sort(function (a, b) {
            ...
            for (var d, e, c, h = j, b = 0; b < f.length - 1; b++) {
                ...
                if (d != e)h = Math.min(h, e - d)
            }
            var i = this.realXAxis, k = i.series, g = k.maxX - k.minX;
            if (i.skipEmptyDays)g -= i.totalEmptyDaysTicks;
            g = Math.min(.5, h / g);
            return g
        },
        ...
        _render: function (a) {
            if (!this.arrData || !this.isInScene())return;
            switch (this.xAxisType) {
                case"LinearAxis":
                case"DateTimeAxis":
    ...
    A.prototype._renderCatData = function (n) {
        ...
        if (!f && l)l.context = {chart: this.chart, series: this, points: i}; else a.merge(n, m);
        return k
    };
    A.prototype._renderLinearData = function (j) {
        ...
        if (!d && o)o.context = {chart: this.chart, series: this, points: h}; else a.merge(j, p);
        return n
    };
    ...
    s.prototype._findXAxis = function (b) {
        ...
        if (a != null)return a;
        var c;
        if (this.categories)c = E; else c = o;
    ...
    s.prototype._renderCatData = function (p) {
        ...
        for (var v = [], s = [], D = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, c, l, d = 0; d < m; d++) {
            ...
            if (n == null)continue;
            var G = d, h;
            if (a.isArray(n) == false)h = n; else h = n[1];
            if (h == null)continue;
    ...
    cb.prototype._processData = function () {
        this.arrData = null;
        if (this.data)if (!this.xValuesType && !this.yValuesType && !this.sizeValuesType)this.arrData = b.cloneArray(this.data); else {
            this.arrData = [];
            for (var d = 0; d < this.data.length; d++) {
                var a = this.data[d].slice(0);
                a[0] = b.processDataValue(a[0], this.xValuesType);
    ...
    cb.prototype._render = function (m) {
        ...
        for (var i = c.length, j, k, f, d, b, a = 0; a < i; a++) {
            ...
            b = e[1];
            f = e[2];
            if (d == null || b == null || f == null)continue;
    ...
    J.prototype._renderCatData = function (p) {
        ...
        for (var u = [], s = [], z = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, g, h, e, c = 0; c < l; c++) {
            ...
            if (m == null)continue;
            g = c;
            if (a.isArray(m) == false)e = m; else e = m[1];
            if (e == null)continue;
    ...
    h.prototype._processData = function () {
        ...
        if (this.data) {
            ...
            if (!this.dataLabelsType && !this.dataValuesType)this.arrData = b.cloneArray(this.data); else {
                this.arrData = [];
    ...
    h.prototype._getYValues = function () {
        for (var e = [], f = this.arrData, g = f.length, d = 0; d < g; d++) {
            ...
            if (b == null)continue;
            var c;
            if (a.isArray(b) == false)c = b; else c = b[1];
            e.push(Math.abs(c))
        }
        return e
    };
    h.prototype._createLabels = function () {
        ...
        if (!B)return f;
        var m = this.chart.gridArea, J = m.width, I = m.height, A = this._getYValues(), D = A.length, E = this.getTotal(), q = this.margin, g = this._calcRadius({
            h: q,
            v: q
        });
        if (g < 0)return f;
        ...
        for (var k, y, p = [], o = b.radians(this.startAngle), z = this.labelsPosition == "outside", u = this.hiddenSlices, F = D - u.length, n = 0, d = 0; d < D; d++) {
            ...
            if (z)k = this._getSliceCenter(h, i, e, g + this.labelsExtend); else k = this._getSliceCenter(h, i, e, g * .6);
            c.x = k.x - C.width / 2;
            c.y = k.y - C.height / 2;
            o = x;
    ...
    h.prototype._arrangeLabels = function (c) {
        var j = c.labels;
        if (!j || this.labelsPosition != "outside")return {margins: {h: this.margin, v: this.margin}, lines: []};
    ...
    h.prototype._hLabelAlign = function (a, j, i, d) {
        ...
        if (k) {
            ...
            if (c < b)if (e.isLeft)a.x = g - a.width - Math.sqrt(b * b - c * c); else a.x = g + Math.sqrt(b * b - c * c)
        } else {
            var f = this.chart.gridArea;
            if (e.isLeft)a.x = f.x + j - a.width; else a.x = f.x + f.width - i
        }
    };
    ...
    h.prototype._getLegendItems = function (c) {
        ...
        for (var m = this._getYValues(), h, o = i.length, b = 0; b < o; b++) {
            ...
            var g = new Z;
            if (k)g.fillStyle = this.getSliceColor(b); else g.fillStyle = c.inactiveFillStyle;
            var l = {
                chart: this.chart,
                series: this,
                dataItem: e,
    ...
    h.prototype._hideFromLegend = function (e) {
        ...
        if (c > -1)b.splice(c, 1); else b.push(d)
    };
    h.prototype._handleEvent = function (j, i) {
        ...
        switch (j) {
            ...
            case"TouchEnd":
                var d = a.inArray(f, c);
                if (d == -1)c.push(f); else c.splice(d, 1);
    ...
    v.prototype._render = function (t) {
        ...
        for (var A = this.chart.series._findStackedClusters(this, this.type), n = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), v = g.length, i = this.markers != null && this.markers.isVisible(), k = [], r = [], s = [], p = [], x = i ? this.markers.size / 2 : 0, y = this.xAxisType, l, m, c, h, d, f, b = 0; b < v; b++) {
            ...
            k.push(l);
            k.push(m);
            var e = c.actualValue, u = this._getStackedTotal(n, j), w = e > 0 ? u.positive : u.negative, o = w != 0 ? 100 * Math.abs(e) / Math.abs(w) : 0, z = {
                chart: this.chart,
                series: this,
                dataItem: c,
                index: b,
        ...
        if (!i && q)q.context = {chart: this.chart, series: this, points: r}; else a.merge(t, s);
        return p
    };
    ...
    K.prototype._renderCatData = function (E) {
        ...
        for (var B = [], A = [], t = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), K = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, h, e, d = 0; d < G; d++) {
            ...
            var n = e.actualValue, F = this._getStackedTotal(t, q), H = n > 0 ? F.positive : F.negative, y = H != 0 ? 100 * Math.abs(n) / Math.abs(H) : 0, u = {
                chart: this.chart,
                series: this,
                dataItem: s[d],
                index: d,
    ...
    K.prototype._renderLinearData = function (C) {
        ...
        for (var A = [], z = [], G = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, d, c = 0; c < L; c++) {
            ...
            var p = d.actualValue, D = this._getStackedTotal(o, s), E = p > 0 ? D.positive : D.negative, x = E != 0 ? 100 * Math.abs(p) / Math.abs(E) : 0, u = {
                chart: this.chart,
                series: this,
                dataItem: h[c],
                index: c,
    ...
    H.prototype._renderCatData = function (E) {
        ...
        for (var B = [], A = [], s = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), L = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, f, i, e, d = 0; d < H; d++) {
            ...
            var n = e.actualValue, F = this._getStackedTotal(s, p), I = n > 0 ? F.positive : F.negative, y = I != 0 ? 100 * Math.abs(n) / Math.abs(I) : 0, t = {
                chart: this.chart,
                series: this,
                dataItem: r[d],
                index: d,
    ...
    H.prototype._renderLinearData = function (C) {
        ...
        for (var A = [], z = [], H = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, e, n, d, c = 0; c < N; c++) {
            ...
            var o = d.actualValue, D = this._getStackedTotal(s, q), F = o > 0 ? D.positive : D.negative, x = F != 0 ? 100 * Math.abs(o) / Math.abs(F) : 0, t = {
                chart: this.chart,
                series: this,
                dataItem: h[c],
                index: c,
    ...
    qb.prototype._getPixelMargins = function (b) {
        if (b.isVertical() == false || !this.hasData())return {left: 0, right: 0};
        var e = 4, f = this._getSeriesFromThisType(), c = this._calcColumnScale(f), d = b.length, a = .5 * c * d + e;
        return {left: a, right: a}
    };
    ...
    G.prototype._renderCatData = function (v) {
        ...
        for (var q, j, l, c, h, i, b = 0; b < g.length; b++) {
            ...
            var s = {
                ...
                from: h,
                to: i
            }, x = Math.min(j, l), t = Math.abs(j - l), d = new k(q, x, f, t);
            d.context = s;
    ...
    t.prototype._renderCatData = function (u) {
        ...
        for (var j, l, q, c, h, i, b = 0; b < g.length; b++) {
            ...
            var s = {
                ...
                from: h,
                to: i
            }, x = Math.min(j, l), w = Math.abs(j - l), e = new k(x, q, w, d);
            e.context = s;
    ...
    F.prototype._processData = function () {
        this.arrData = null;
        if (this.data)if (!this.xValuesType && !this.highValuesType && !this.lowValuesType && !this.openValuesType && !this.closeValuesType)this.arrData = b.cloneArray(this.data); else {
            this.arrData = [];
            for (var d = 0; d < this.data.length; d++) {
                var a = this.data[d].slice(0);
                a[0] = b.processDataValue(a[0], this.xValuesType);
    ...
    F.prototype._render = function (q) {
        var j = this.arrData;
        if (!j || !this.isInScene())return;
        var r = this.chart.gridArea, k = j.length, d, f, h, g, e, m = r.width / this.realXAxis.getZoom(), i;
        if (this.xAxisType == "CategoryAxis")i = this.pointWidth * m / k; else {
    ...
    D.prototype._render = function (n) {
        ...
        if (m) {
            n.push(m);
            if (!g)m.context = {chart: this.chart, series: this, points: j}
        }
        a.merge(n, p);
        a.merge(n, o)
    };
    ...
    T.prototype._getRegression = function (m, g) {
        ...
        if (h == "linear") {
            c = m;
            d = g
        } else if (h == "exp" || h == "exponential")for (var a = 0; a < g.length; a++)if (g[a] <= 0)e--; else {
            c.push(m[a]);
            d.push(Math.log(g[a]))
        }
        for (var a = 0; a < e; a++) {
    ...
    N.prototype._renderLinearData = function (o) {
        ...
        if (!e && m)m.context = {chart: this.chart, series: this, points: h}; else a.merge(o, n);
        return l
    };
    ...
    y.prototype._renderCatData = function (r) {
        for (var s = this.arrData, k = s.length, e = this.markers != null && this.markers.isVisible(), c = [], d = [], f = [], q = [], o = [], t = e ? this.markers.size / 2 : 0, j, m, n, l, g, h, b = 0; b < k; b++) {
            ...
            d.push(j);
            d.push(n);
            if (!e)f[b] = f[2 * k - b - 1] = {dataItem: i, index: b, x: l, from: g, to: h};
            this._addMarkersAndLabels(q, o, j, m, n, b, k, null, g, h, t)
        }
        var p = this._createShape(c, d, r);
        if (!e && p)p.context = {chart: this.chart, series: this, points: f}; else a.merge(r, q);
        return o
    };
    y.prototype._renderLinearData = function (r) {
        for (var s = this.arrData, k = s.length, d = this.markers != null && this.markers.isVisible(), u = this.labels != null && this.labels.visible !== false, i = [], j = [], e = [], q = [], o = [], t = d ? this.markers.size / 2 : 0, h, m, n, l, f, g, b = 0; b < k; b++) {
            ...
            j.push(h);
            j.push(n);
            if (!d)e[b] = e[2 * k - b - 1] = {dataItem: c, index: b, x: l, from: f, to: g};
            this._addMarkersAndLabels(q, o, h, m, n, b, k, null, f, g, t)
        }
        var p = this._createShape(i, j, r);
        if (!d && p)p.context = {chart: this.chart, series: this, points: e}; else a.merge(r, q);
        return o
    };
    ...
    y.prototype._addMarkersAndLabels = function (g, n, i, p, q, a, h, o, d, e, m) {
        ...
        if (this.labels && this.labels.visible !== false) {
            var j = this._getLabelValue(d, a), c = this._getDataPointLabel(d, i, p, m + k, j, d > e), f = {
                chart: this.chart,
                series: this,
                dataItem: data[a],
                index: a
    ...
    r.prototype._updateCrossings = function () {
        ...
        if (d)for (var e = d.getPosition(d.crossing), f = this._getHAxes(), b = 0; b < f.length; b++) {
            var a = f[b];
            a.crossOffsetY = e - a.y;
            if (a.location == "top")a.crossOffsetY -= a.height
        }
        if (c)for (var e = c.getPosition(c.crossing), g = this._getVAxes(), b = 0; b < g.length; b++) {
            var a = g[b];
    ...
    n.prototype._setVisibleRanges = function () {
        ...
        this.jqRangeSlider.jqRangeSlider("update", {
            ...
            largeChange: 2 * a,
            minRange: a / 100,
            range: {minimum: this.actualVisibleMinimum, maximum: this.actualVisibleMaximum}
        })
    };
    ...
    n.prototype._moveVisibleRange = function (f, g) {
        ...
        if (e)a = -d * g / this.length; else a = d * f / this.length;
    ...
    E.prototype._getValue = function (c) {
        ...
        if (this.arrCats && b < this.arrCats.length)a = this.arrCats[b]; else a = this.seriesCategories[b];
        return a
    };
    E.prototype.getLabel = function (d) {
        var b;
        if (a.type(d) == "string")b = d; else {
            var c = Math.round(d - .5);
            if (this.arrCats && c < this.arrCats.length)b = this.arrCats[c]; else b = this.seriesCategories[c]
        }
        b = b || "";
    ...
    o.prototype._initRange = function () {
        ...
        if (t && this.getOrientation() == "y")if (e >= g && a < g)a = g; else if (c <= g && d > g)d = g;
        if (this.extendRangeToOrigin)if (a > g)a = g; else if (d < g)d = g;
        if (this.logarithmic === true) {
            var s = 1;
            if (a < s)a = s;
            a = b.log(a, this.logBase);
        ...
        this._setMinMax(a, d);
        this._setVisibleRanges();
        if (this.logarithmic === true)this.actualInterval = this._calculateActualIntervalLogarithmic(this.actualVisibleMinimum, this.actualVisibleMaximum); else this.actualInterval = this._calculateActualInterval(this.actualVisibleMinimum, this.actualVisibleMaximum)
    };
    o.prototype._addPlotsInRange = function (c, a) {
        var f = this.plotLines;
        if (f)for (var d = 0; d < f.length; d++) {
            var i = f[d].value;
            if (!b.isNull(i)) {
                c = Math.min(c, i);
                a = Math.max(a, i)
    ...
    o.prototype.getOrientation = function (b) {
        ...
        if (this.series)for (var c = 0; c < this.series.items.length; c++)b = this.series.items[c];
    ...
    p.prototype._initDefs = function () {
        ...
        var b = a.jqChartDateFormat.masks, c = a.extend(true, {}, this.defaults, {
            labels: {
    ...
    p.prototype._setMinMax = function (c, b) {
        if (this.minimum != null)if (a.type(this.minimum) == "date")this.actualMinimum = this.minimum.getTime(); else this.actualMinimum = this.minimum; else this.actualMinimum = c;
        if (this.maximum != null)if (a.type(this.minimum) == "date")this.actualMaximum = this.maximum.getTime(); else this.actualMaximum = this.maximum; else this.actualMaximum = b
    };
    p.prototype._calculateActualInterval = function (c, b) {
        ...
        if (this.intervalType != null)this.actualIntervalType = this.intervalType; else this.actualIntervalType = this.type;
    ...
    p.prototype._incrementDateTime = function (h, b, c) {
        ...
        if (c == "days")a = g.addDays(a, b); else if (c == "hours")d = g.fromHours(b); else if (c == "milliseconds")d = b; else if (c == "seconds")d = g.fromSeconds(b); else if (c == "minutes")d = g.fromMinutes(b); else if (c == "weeks")a = g.addDays(a, 7 * b); else if (c == "months") {
            var e = false;
    ...
    p.prototype._getEmptyDays = function () {
        for (var b = [], a = 0; a < this.series.items.length; a++) {
            ...
            if (a == 0)b = this._getEmptyDaysFromSeries(c); else this._excludeDaysFromSeries(c, b)
        }
        return b
    };
    ...
    p.prototype._getTooltip = function (b) {
        ...
        if (b.getSeconds() != 0)d += c.shortDate + " " + c.longTime; else if (b.getHours() != 0 || b.getMinutes() != 0)d += c.shortDate + " " + c.shortTime; else d = c.shortDate;
    ...
    L.prototype._getLabels = function () {
        ...
        for (var i = this.cx, j = this.cy, n = i, o = j - this.radius, m = 2 * Math.PI / g, c = 8, h = [], f = this.labels, e = 0; e < g; e++) {
            ...
            if (d == Math.PI) {
                ...
                a.x -= a.width / 2;
                a.y -= c
            } else if (d > Math.PI)a.x -= a.width + c; else a.x += c;
            h.push(a)
        }
        return h
    };
    ...
    C.prototype._getAngle = function (g) {
        ...
        if (e === 0)a = c + d / 2; else a = c + d * (g - this.actualMinimum) / e;
        if (this.reversed === true)a = 2 * Math.PI - a;
        return a - Math.PI / 2
    };
    C.prototype._getLabels = function () {
        ...
        for (var j = this.cx, k = this.cy, p = j + this.radius, q = k, e = 8, g = [], n = this._getMarkInterval(d, true), h = this._getLabelIntervals(n, d), o = this._getIntervalsLength(h), f = 0; f < o; f++) {
            ...
            if (c == Math.PI) {
                ...
                a.x -= a.width / 2;
                a.y -= e
            } else if (c > Math.PI)a.x -= a.width + e; else a.x += e;
            g.push(a)
        }
        return g
    };
    ...
    ub.prototype._getYValues = function () {
        for (var h = this.series, e = h.arrData, j = e.length, i = h.xAxisType, c, d, g = [], f = 0; f < e.length; f++) {
            c = e[f];
            if (c === null)continue;
            if (i == "CategoryAxis")if (a.isArray(c) == false)d = c; else d = c[1]; else d = c[1];
            !b.isNull(d) && g.push(d)
        }
        return g
    };
    ...
    ub.prototype._createShapes = function (n) {
        for (var f = this.series, y = f.isVertical, x = f.arrData, A = x.length, z = f.xAxisType, m, o, h, c, p, q, d, r, s, v, w, e, j, k, g = this.displayType, u = this.errorAmount, l = this.capLength / 2, t = 0; t < x.length; t++) {
            ...
            if (z == "CategoryAxis") {
                o = t + .5;
                if (a.isArray(m) == false)h = m; else h = m[1]
            } else {
                o = m[0];
                h = m[1]
            }
